...
NOTE: Wenn Sie diesen oder einen anderen Port verwenden, um eine Verbindung zum VMware vCenter Server oder ESXi-Server herzustellen, stellen Sie sicher, dass der Port verfügbar ist und an einem sicheren Standort eine Verbindung hergestellt werden kann.
