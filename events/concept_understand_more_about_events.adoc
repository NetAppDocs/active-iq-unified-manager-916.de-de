...
summary: Wenn Sie die Konzepte zu Ereignissen verstehen, können Sie Ihre Cluster und Clusterobjekte effizienter verwalten und Warnmeldungen entsprechend definieren. 
---
