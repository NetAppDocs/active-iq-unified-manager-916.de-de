...
. Wenn Sie Unified Manager unter Windows installieren, installieren Sie Logrotate Version 0.0.0.18.  Weitere Informationen finden Sie imlink:https://www.netapp.com/pdf.html?item=/media/78941-tr-4945.pdf["Leitfaden zur Sicherheitshärtung für den technischen Bericht zum NetApp Manageability SDK"^] .
