...
summary: Sie können die Reihenfolge der Gruppenaktionen ändern, die auf die Speicherobjekte in einer Gruppe angewendet werden sollen.  Gruppenaktionen werden auf Speicherobjekte nacheinander basierend auf ihrem Rang angewendet.  Der niedrigste Rang wird der Gruppenaktion zugewiesen, die Sie zuletzt konfiguriert haben.  Sie können den Rang der Gruppenaktion je nach Ihren Anforderungen ändern. 
---
...
. Klicken Sie auf der Registerkarte *Gruppenaktionen* auf *Neu anordnen*.
. Ziehen Sie im Dialogfeld *Gruppenaktionen neu anordnen* die Zeilen per Drag & Drop, um die Reihenfolge der Gruppenaktionen nach Bedarf neu anzuordnen.
