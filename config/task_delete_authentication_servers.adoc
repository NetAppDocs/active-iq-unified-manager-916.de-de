...
Wenn Sie einen Authentifizierungsserver löschen, können Remotebenutzer oder Gruppen des Authentifizierungsservers nicht mehr auf Unified Manager zugreifen.
